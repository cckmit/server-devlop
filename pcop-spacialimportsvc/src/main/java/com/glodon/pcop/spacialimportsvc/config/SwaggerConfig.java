...
public class SwaggerConfig {
    ...
    public Docket createRestApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                .apiInfo(apiInfo())
                .select()
				.apis(RequestHandlerSelectors.basePackage("com.glodon.pcop"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
				.title("Glodon PCOP CIM Spacial Import Services")
                .description("The CIM Data services of Glodon Plan Construction Operation Platform")

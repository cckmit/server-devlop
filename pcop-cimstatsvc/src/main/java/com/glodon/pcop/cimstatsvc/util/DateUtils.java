...
public class DateUtils {
    ...
    public static String getDayRange() {
        SimpleDateFormat sdf2 = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        Date start = getDayBegin();
        String startString = sdf2.format(start.getTime());
        Date end = getDayEnd();
        String endString = sdf2.format(end.getTime());
        return " Between \"" + startString + "\" AND \"" + endString + "\" ";
    }

    public static String getMonthRangeFormNow() {
        SimpleDateFormat sdf2 = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        Date start = getDayBegin();
        String startString = sdf2.format(start.getTime());
        Date end = getFrontDay(start, 30);
        String endString = sdf2.format(end.getTime());
        return " Between \"" + endString + "\" AND \"" + startString + "\" ";
    }
    /**
     * 获取当天的开始时间
     *

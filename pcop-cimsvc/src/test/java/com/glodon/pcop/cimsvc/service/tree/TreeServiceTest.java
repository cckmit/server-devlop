...
public class TreeServiceTest {
	...
	private InstancesService instancesService = new InstancesService();
	...
	public void setUp() throws Exception {
		...
		ehcacheConfig.setClusterEnable(false);
		...
		treeService.setDataPermissionService(dataPermissionService);
	}
	...
	public void addNodeInfo() {
		...
		try {
			...
			parentNode.setID("QingDaoCityComponentTree_6c44023e-56f5-472d-ad75-a55e0019aa06_1560339022190");
			parentNode.setNAME("测试第四级节点003");
			...
			childNode.setID("t003-003-001");
			childNode.setNAME("测试第四级节点001");
			childNode.setTreeDefId("QingDaoCityComponentTree");
	...
	public void addRootInstanceNode() {
		...
		String treeDefId = permissionSchemaTree;
		IndustryNodeAddInputBean nodeInfo = new IndustryNodeAddInputBean();
		Map<String, Object> metadata = new HashMap<>();

...
public class IndustryTypeServiceTest {
    ...
    private static IndustryTypeService industryTypeService;
    ...
    public static void setUp() {
        ...
        tenantId = "1";
        industryTypeService = new IndustryTypeService();
        InfoObjectTypeDefsService objectTypeDefService = new InfoObjectTypeDefsService();

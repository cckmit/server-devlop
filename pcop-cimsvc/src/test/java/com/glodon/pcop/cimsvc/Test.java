...
public class Test {
    ...
    public static String doGet(String httpurl) {
        ...
        try {
            ...
            connection.setRequestProperty("PCOP-TENANTID", "1");
            connection.setRequestProperty("PCOP-USERID", "1");
            // 发送请求
            connection.connect();
...
//            connection.setRequestProperty("Authorization", "Bearer da3efcbf-0845-4fe3-8aba-ee040be542c0");
    ...
    public static void main(String[] args) {
        ...
        try {
            System.out.println(objectMapper.writeValueAsString(fileUploadTranslateBean));
